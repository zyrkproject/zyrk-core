...
bool CAnonymizeAddress::SetEncoded(const std::string& encodedAddress)
{
    data_chunk raw;
...
std::string CAnonymizeAddress::Encoded() const
{
    // https://wiki.unsystem.net/index.php/DarkWallet/Stealth#Address_format
    // [version] [options] [scan_key] [N] ... [Nsigs] [prefix_length] ...
...
bool IsAnonymizeAddress(const std::string& encodedAddress)
{
    data_chunk raw;

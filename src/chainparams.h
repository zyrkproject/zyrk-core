...
public:
    ...
    CAmount SubsidyValue(DynamicRewardSystem::key_type level, uint32_t nTime) const;
    ...
    const DynamicRewardSystem& GetDynamicRewardSystem(uint32_t nTime) const
    {
       return dynamicRewardSystem;
    }
...
protected:
    ...
    DynamicRewardSystem dynamicRewardSystem;

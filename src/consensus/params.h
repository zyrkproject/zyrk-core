...
struct Params {
    ...
    int nMasternodeInitialize;

    //block to reduce coinbase age from 500 to 200
    int nCoinMaturityReductionHeight;

    //block to start proper AnonymizeFee distribution every 720 blocks
    int nStartAnonymizeFeeDistribution;
    int nAnonymizeFeeDistributionCycle;

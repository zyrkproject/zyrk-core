...
static const CAmount PRIVATESEND_POOL_MAX           = 99.999 * COIN;
...
{
public:
    /// Is the input associated with this public key? (and there is 10000 ZYRK - checking if valid masternode)

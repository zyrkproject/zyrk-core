...
static const int MASTERNODE_SYNC_ENOUGH_PEERS    = 1;  //Mainnet PARAMS
static const int MASTERNODE_SYNC_ENOUGH_PEERS_TESTNET    = 1;  //Testnet PARAMS
...
public:
    ...
    bool IsSynced(int nHeight) { return (nHeight >= 6) ? nRequestedMasternodeAssets == MASTERNODE_SYNC_FINISHED : true; }

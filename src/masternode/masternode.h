...
static const int MASTERNODE_MIN_MNB_SECONDS             =   5 * 60; //BROADCAST_TIME
static const int MASTERNODE_MIN_MNP_SECONDS             =  10 * 60; //PRE_ENABLE_TIME
static const int MASTERNODE_EXPIRATION_SECONDS          =  65 * 60;
static const int MASTERNODE_WATCHDOG_MAX_SECONDS        = 120 * 60;
static const int MASTERNODE_NEW_START_REQUIRED_SECONDS  = 180 * 60;
static const int MASTERNODE_COIN_REQUIRED  = 7500;

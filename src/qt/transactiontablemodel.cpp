...
QString TransactionTableModel::formatTxStatus(const TransactionRecord *wtx) const
{
    ...
    case TransactionStatus::Abandoned:
        status = tr("Abandoned");
        break;
    case TransactionStatus::Shading:
        status = tr("Shading (%1 of 1 recommended confirmations)").arg(wtx->status.depth);
...
QString TransactionTableModel::formatTxType(const TransactionRecord *wtx) const
{
    ...
    case TransactionRecord::SendToOther:
        return tr("Sent to");
    case TransactionRecord::Anonymized:
        return tr("Creating Anonymized Zyrk");
    case TransactionRecord::UnAnonymized:
        return tr("De-Anonyminzing Zyrk");

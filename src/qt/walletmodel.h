...
private:
    ...
    CAmount cacheAnonymizeBalance;
    CAmount cacheAnonymizeBalanceUnconfirmed;
...
Q_SIGNALS:
    ...
    void balanceChanged(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance,
                        const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance, const CAmount& anonymizeBalance, const CAmount& anonymizeBalanceUnconfirmed, const CAmount& stakeBalance, const CAmount& watchStakeBalance);

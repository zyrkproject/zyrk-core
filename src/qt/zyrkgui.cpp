...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZYRK address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ZYRK: URIs)"));
    ...
    masternodeAction = new QAction(platformStyle->SingleColorIcon(":/icons/about"), tr("&Masternodes"), this);
    masternodeAction->setStatusTip(tr("Browse/Enable Masternodes"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZYRK addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZYRK addresses"));
    ...
    openAction->setStatusTip(tr("Open a ZYRK: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible ZYRK command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to ZYRK network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
void BitcoinGUI::setAdditionalDataSyncProgress(int count, double nSyncProgress)
{
    ...
    if(masternodeSync.IsBlockchainSynced())
    {
        ...
        if(masternodeSync.IsSynced(count)) {
            progressBarLabel->setVisible(false);
            progressBar->setVisible(false);
...
{
    QString strTitle = tr("ZYRK"); // default title

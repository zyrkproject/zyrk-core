...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    //ZYRK Privacy functions
    { "setmininput", 0 , "amount"},
    { "anonymizeamount", 0 , "amount"},
    { "unanonymizeamount", 0 , "amount"},
    { "setgenerate", 0 , "bool"},
    { "setgenerate", 1 , "bool"},
    { "setanonymizedzyrkstatus", 2 ,""},
    { "setanonymizedzyrkstatus", 1 ,""},
    { "listunspentanonymizedzyrk", 0 ,""},
    { "listpubcoins", 0, ""},
    { "getnewstealthaddress", 1 ,"label"},
    { "importstealthaddress", 0 ,"scan_secret"},
    { "liststealthaddresses", 0, "show_secrets"},

    //ZYRK Staking functions
    ...
    {"refillanonymizekeys", 0, "amount"},
    {"listanonymizedzyrk", 0, "all"},

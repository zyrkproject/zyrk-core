...
typedef struct {
  ...
  config_line_t *ControlPort_lines; /**< Ports to listen on for control
                               * connections. */
  config_line_t *ControlSocket; /**< List of Uzyrk Domain Sockets to listen on
  ...
  int ConnLimit_low_thresh; /**< try to get down to here after socket
                             *   exhaustion. */
  int RunAsDaemon; /**< If true, run in the background. (Uzyrk only) */
  ...
  char *ServerDNSResolvConfFile; /**< If provided, we configure our internal
                     ...
                     * /etc/resolv.conf (Uzyrk) or the registry (Windows). */

...
enum AvailableCoinsType
{
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT7500IFMN = 3,
    ONLY_NONDENOMINATED_NOT7500IFMN = 4,
    ONLY_7500 = 5, 
...
public:
     ...
     */
    void AvailableCoins(std::vector<COutput>& vCoins, bool fOnlySafe=true, const CCoinControl *coinControl = nullptr, const CAmount& nMinimumAmount = 1, const CAmount& nMaximumAmount = MAX_MONEY, const CAmount& nMinimumSumAmount = MAX_MONEY, const uint64_t nMaximumCount = 0, const int nMinDepth = 0, const int nMaxDepth = 9999999, AvailableCoinsType nCoinType=ALL_COINS, bool includeImmature = false) const;
    ...
    CAmount GetAnonymizeBalance() const;
    CAmount GetAnonymizeBalanceUnconfirmed() const;
    ...
    bool FindUnloadedAnonymizeTransactions(const CTransaction& tx);
    ...
    /**
     * Add Anonymize functions
     */
    bool EnableAnonymizeMode(SecureString strWalletPass,string totalAmount);
    bool DisableAnonymizeMode();
    bool AnonymizeModeMintTrigger(string totalAmount, vector<CScript> pubCoinScripts = vector<CScript>());
    ...
    void NotifyAnonymizeChanged(CWallet *wallet, const std::string &pubCoin, int denomination, const std::string &isUsed, ChangeType status);
